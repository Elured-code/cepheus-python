...
def main():
    ...
    if __name__ == "__main__":
        ...
        parser.add_argument("-f", "--namefile", default='', help='System names file')
    ...
    s1 = TR_CE_Subsector.Subsector(ARG_NAME, ARG_SECTOR, ARG_LETTER, stellarDensity)
    s1.genSubSec()
    print("```")
    s1.printSubSec()
    print("```")
